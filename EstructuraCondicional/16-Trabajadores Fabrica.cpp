/*
Los trabajadores de una fabrica tienen tres turnos: ma�ana, tarde y noche. La tarifa de
los turnos de ma�ana y tarde son iguales, mientras que de noche son 30 por ciento mayores.
...
int main()
{
	...
	if (op == 1 || op == 2)
	{
		...
		cout << "Su salario semanal es: " << (h * (t + (t * 0.3))) * 7 << " soles." << endl;
